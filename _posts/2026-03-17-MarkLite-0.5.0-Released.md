...
MarkLite version 0.5.0 has been released with refactoring of the keyboard handler and markdown viewer code to keep pushing the program to be light and fast, also new a feature to support GitLib specift markdown extensions. 
