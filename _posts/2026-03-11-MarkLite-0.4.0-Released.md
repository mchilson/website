---
title: MarkLite Markdown Viewer/Editor Version 0.4.0 Released
layout: post
...
MarkLite version 0.4.0 has been release with the updated Dart and Flutter versions, Refactoring of code to keep the program light and fast, also added a feature to track any changes to an open file if another program modifies it. 
