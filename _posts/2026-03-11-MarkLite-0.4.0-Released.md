...
layout: post
post-image: "https://mikechilson-blog-assets.s3.us-east-1.amazonaws.com/marklite-0.4.0.jpg"
...
MarkLite version 0.4.0 has been released with updated Dart and Flutter versions, Refactoring of code to keep the program light and fast, also added a feature to track any changes to an open file if another program modifies it. 
